                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1" style="width: 200px;">Name Product</span>
                                    </div>
                        ...
                        <div class="form-row">
                            <div class="col">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1" style="width: 200px;">Type Product</span>
                                    </div>
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="my-modal-title" style="color:firebrick; margin-left: 150px; font-size: 25px;">EDIT PRODUCT</h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon1" style="width: 150px;">Name Product</span>
                                                </div>
                                            ...
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon1" style="width: 150px;">Type Product</span>
                                                </div>
                                                <select class="form-control col-md-9" name="typePr" id="" value="<?php echo $Products[$i]->getType()?>" placeholder="">
                                                    <option value="QUÀ ĐỂ BÀN">QUÀ ĐỂ BÀN</option>
                                                    <option value="QUÀ TẶNG PHA LÊ">QUÀ TẶNG PHA LÊ</option>
                                                    <option value="GẤU BÔNG">GẤU BÔNG</option>
                                                    <option value="MÓC KHÓA">MÓC KHÓA</option>
                                        ...
                                        <div class="modal-footer d-flex justify-content-center">
                                            <button class="btn btn-default" style="border-style:solid; background:firebrick;color:floralwhite; font-size:12px" type="submit" name="edit" value="<?php echo $result[$i][0];?>">OK</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
